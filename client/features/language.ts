...
function applyHeaders(lang: Translation): void {
...
function applyTitles(titles: Titles): void {
...
function applyTableLabels(labels: TableLabels): void {
...
export function renderLanguageDropdown(anchor: HTMLElement) {
